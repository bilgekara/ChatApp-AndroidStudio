                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(task.getResult().getAdditionalUserInfo().isNewUser()){
                                ...
                                hashMap.put("uid",uid);
                                hashMap.put("name","");//will ad later (e.g edit profile)
                                hashMap.put("onlineStatus","online");//will ad later (e.g edit profile)
                                hashMap.put("typingTo","noOne");//will ad later (e.g edit profile)

                                hashMap.put("phone","");//will ad later (e.g edit profile)
                                hashMap.put("image","");//will ad later (e.g edit profile)
                                hashMap.put("cover","");//will ad later (e.g edit profile)
